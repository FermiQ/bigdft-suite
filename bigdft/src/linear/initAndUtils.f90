...
subroutine adjust_locregs_and_confinement(iproc, nproc, hx, hy, hz, at, input, &
  ...
  if(locreg_increased) then
     ...
     call get_sparsematrix_local_extent(iproc, nproc, tmb%linmat%smmd, tmb%linmat%s, ind_min_s, ind_mas_s)
     ...
     call get_sparsematrix_local_extent(iproc, nproc, tmb%linmat%smmd, tmb%linmat%m, ind_min_m, ind_mas_m)
     ...
     call get_sparsematrix_local_extent(iproc, nproc, tmb%linmat%smmd, tmb%linmat%l, ind_min_l, ind_mas_l)
     call check_local_matrix_extents(iproc, nproc, tmb%ham_descr%collcom, &
