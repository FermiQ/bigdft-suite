module transposed_operations
  ...
  contains
    ...
    subroutine calculate_overlap_transposed(iproc, nproc, orbs, collcom, &
               psit_c1, psit_c2, psit_f1, psit_f2, smat, aux, ovrlp)
      use module_base
      ...
      method_if: if (collcom%imethod_overlap==2) then
       ...
       !!   end do
          ...
          !auxiliary array with shifted bounds in order to access aux%matrixindex_in_compressed_fortransposed
                  ...
                  do ipt=1,collcom%nptsp_c 
                      ...
                      do i=1,ii
                          ...
                          do j=m+1,ii,7
                              ...
                              if (jjorb0<aux%mat_ind_compr(iiorb)%offset_compr) then
                                  jorb0 = jjorb0 + smat%nfvctr
                              else
                                  jorb0 = jjorb0
                              end if
                              ...
                              if (jjorb1<aux%mat_ind_compr(iiorb)%offset_compr) then
                                  jorb1 = jjorb1 + smat%nfvctr
                              else
                                  jorb1 = jjorb1
                              end if
                              ...
                              if (jjorb2<aux%mat_ind_compr(iiorb)%offset_compr) then
                                  jorb2 = jjorb2 + smat%nfvctr
                              else
                                  jorb2 = jjorb2
                              end if
                              ...
                              if (jjorb3<aux%mat_ind_compr(iiorb)%offset_compr) then
                                  jorb3 = jjorb3 + smat%nfvctr
                              else
                                  jorb3 = jjorb3
                              end if
                              ...
                              if (jjorb4<aux%mat_ind_compr(iiorb)%offset_compr) then
                                  jorb4 = jjorb4 + smat%nfvctr
                              else
                                  jorb4 = jjorb4
                              end if
                              ...
                              if (jjorb5<aux%mat_ind_compr(iiorb)%offset_compr) then
                                  jorb5 = jjorb5 + smat%nfvctr
                              else
                                  jorb5 = jjorb5
                              end if
                              ...
                              if (jjorb6<aux%mat_ind_compr(iiorb)%offset_compr) then
                                  jorb6 = jjorb6 + smat%nfvctr
                              else
                                  jorb6 = jjorb6
                              end if
      ...
      !write(*,*) 'ovrlp%matrix_compr',ovrlp%matrix_compr
    ...
    subroutine build_linear_combination_transposed(collcom, sparsemat, aux, mat, psitwork_c, psitwork_f, &
      ...
      spin_loop: do ispin=1,sparsemat%nspin
          ...
          !$omp shared(collcom, psit_c, psitwork_c, psit_f, psitwork_f, sparsemat, aux) &
