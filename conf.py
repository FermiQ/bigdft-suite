# -*- coding: utf-8 -*-
#
# BigDFT-suite documentation build configuration file, created by
...
templates_path = ['sphinxdoctemplates']
...
exclude_patterns = ['sphinxdocbuild','cmake*','ipython','openbabel','PyBigDFT','futile', 'Thumbs.db', '.DS_Store']
...
htmlhelp_basename = 'BigDFT-suitedoc'
...
latex_documents = [
    (master_doc, 'BigDFT-suite.tex', u'BigDFT-suite Documentation',
     u'BigDFT developers', 'manual'),
]
...
man_pages = [
    (master_doc, 'bigdft-suite', u'BigDFT-suite Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'BigDFT-suite', u'BigDFT-suite Documentation',
     author, 'BigDFT-suite', 'A DFT suite based on Wavelets.',
     'Miscellaneous'),
]
